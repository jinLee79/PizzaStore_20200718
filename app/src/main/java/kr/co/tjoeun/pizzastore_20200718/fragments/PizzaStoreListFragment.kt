...
import kr.co.tjoeun.pizzastore_20200718.ViewPizzaStoreDetailActivity
import kr.co.tjoeun.pizzastore_20200718.adapters.PizzaStoreListAdapter
...
class PizzaStoreListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.pizza_store_list_item, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        mPizzaStoreList.add(PizzaStore("미스터 피자","1577-3082", "https://post-phinf.pstatic.net/MjAxODEyMDVfMzYg/MDAxNTQzOTYxOTA4NjM3.8gsStnhxz7eEc9zpt5nmSRZmI-Pzpl4NJvHYU-Dlgmcg.7Vpgk0lopJ5GoTav3CUDqmXi2-_67S5AXD0AGbbR6J4g.JPEG/IMG_1641.jpg?type=w1200"))
